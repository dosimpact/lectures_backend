// 1. 상속
// - 1.1 부모클래스 정의 > abstract class 는 생성에 닫혀있고 상속만 가능
//  ㄴ 코틀린에선 기본적으로 일반클래스는 상속이 불가능 > open 이라는 키워드
// - 1.2 extends, override 허용하려면 `open` 이라는 예약어를 걸어주자.
// - 1.3 상속시 부모클래스의 생성자를 호출해줘야 한다.
